...
[brief](docs/samples/order-pipeline.brief.md) · [guide](docs/samples/order-pipeline.guide.md) · [spec](docs/samples/order-pipeline.json) · [order-pipeline.drawio](docs/samples/order-pipeline.drawio) — Step Functions 팬아웃(한 번 꺾임), 한국어 제목, 관계 라벨 12/13 개와 단계별 가이드 예시
