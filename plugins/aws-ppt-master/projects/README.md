...
python3 skills/aws-ppt-master/scripts/project_manager.py init my_project
# Or record an exact registered canvas:
python3 skills/aws-ppt-master/scripts/project_manager.py init my_widescreen --format ppt169
```
