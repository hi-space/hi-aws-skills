...
```bash
python3 skills/aws-ppt-master/scripts/sound_sync.py projects/deck bigsoundbank/1797 kenney-interface/click_001
```
...
```bash
python3 skills/aws-ppt-master/scripts/sound_sync.py list --query transition
```
