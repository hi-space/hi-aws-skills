...
| Excluded package behavior | Speaker notes, animations, transitions, PPTX relationships, and direct native-PPTX workflows remain separately owned. They are not part of the SVG page-design contract. |
