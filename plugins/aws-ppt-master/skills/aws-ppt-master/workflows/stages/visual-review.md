...
python3 skills/aws-ppt-master/scripts/svg_editor/server.py <project_path> --no-browser   # live-preview server (skip if already running)
```
...
```bash
python3 skills/aws-ppt-master/scripts/visual_review.py <project_path>
```
