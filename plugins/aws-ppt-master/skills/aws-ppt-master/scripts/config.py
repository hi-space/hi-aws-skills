...
def load_prefixed_env_file(
    ...
    *,
    ...
    requested prefixes are ignored so one shared .env can hold image and
    search credentials without leaking unrelated values into the
    process.
    """
...
# config consumers.
SVG_CONSTRAINTS = {
    'authority': 'skills/aws-ppt-master/references/shared-standards.md',
    'core_authority': 'skills/aws-ppt-master/references/shared-standards-core.md',
    'conditional_authorities': {
        'effects': 'skills/aws-ppt-master/references/svg-effects.md',
        'native_data': 'skills/aws-ppt-master/references/native-data-interface.md',
        'pptx_structure': 'skills/aws-ppt-master/references/pptx-structure-interface.md',
    },
    'validator': 'skills/aws-ppt-master/scripts/svg_quality_checker.py',
}
