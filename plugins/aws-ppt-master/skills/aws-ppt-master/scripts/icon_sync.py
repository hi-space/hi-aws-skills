...
`simple-icons` and `aws` may accompany one of the four stylistic libraries for
real brand / AWS service marks.
...
_SYNC_LIBRARIES = _STYLISTIC_LIBRARIES | {"simple-icons", "aws"}
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    if len(stylistic_libraries) > 1:
        ...
        print(
            ...
            "simple-icons and aws may coexist for real brand / AWS service marks.",
            file=sys.stderr,
        )
        return 1
