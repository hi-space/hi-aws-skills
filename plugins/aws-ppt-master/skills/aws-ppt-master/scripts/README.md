...
This directory contains user-facing scripts for conversion, project setup, SVG processing, source-preserving PPTX editing, export, and image generation.
...
| Image tools | `image_gen.py`, `image_treat.py`, `analyze_images.py` | [docs/image.md](./docs/image.md) |
