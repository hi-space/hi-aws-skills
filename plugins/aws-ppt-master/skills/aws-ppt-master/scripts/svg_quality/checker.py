...
class SVGQualityChecker:
        ...
        *,
        ...
        try:
            ...
            if root is not None:
                ...
                # 10. Check attribution-required image credit text. Templates
                #    don't carry image_sources.json; skip in template mode.
                if not self.template_mode:
    ...
    def _check_sourced_image_attribution(
        ...
        """Require visible credit text for attribution-required sourced images.

        The image sources manifest images/image_sources.json records the legal tier;
        ...
        for item in items:
            ...
            if not has_credit:
                result['errors'].append(
                    ...
                    f"references/svg-image-embedding.md."
                )
    ...
    def _check_pptx_structure_contract(
        ...
        if standard_project and declared_mode != 'structured':
            self._pptx_structure_issues.append((
                ...
                'workspace through skills/aws-ppt-master/workflows/create-template.md '
    ...
    def _check_illustration_resource_contract(self, dir_path: Path) -> None:
        ...
        # ``Type: Source`` marks a user/ai original that only feeds
    ...
    def _check_planned_image_closure(
        ...
        placed_rows = [
            ...
            in {'ai', 'user', 'formula', 'placeholder', 'slice'}
        ]
        rows_by_filename = {
        ...
        if check_structure:
            ...
            if native_contract_path.exists() or source_template_path.exists():
                ...
                self._template_issues.append((
                    ...
                    "through "
                    "skills/aws-ppt-master/workflows/create-template.md",
                ))
            ...
            if legacy_structure_detected:
                self._template_issues.append((
                    ...
                    "workspace through skills/aws-ppt-master/workflows/"
