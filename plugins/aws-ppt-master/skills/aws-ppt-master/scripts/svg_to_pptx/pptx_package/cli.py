    ...
    *,
    ...
    if requested_mode == 'structured':
        ...
        print(
            ...
            "through skills/aws-ppt-master/workflows/create-template.md, then generate "
...
''',
    ...
    if release_quality_gate:
        ...
        if quality_gate != 'passed':
            ...
            print(
                "Run: python3 skills/aws-ppt-master/scripts/svg_quality_checker.py "
    ...
    if effective_animation_config:
        ...
        if not config_path.exists():
            ...
            if (
                ...
                print(
                    "Select the canonical config with --animation-config animations.json, "
