...
```bash
python3 skills/aws-ppt-master/scripts/pptx_template_import.py "<reference_template.pptx>" [--inheritance-mode layered|both|flat]
```
...
```bash
python3 skills/aws-ppt-master/scripts/svg_authoring_view.py "<normalized_svg_source>" -o "<svg_analysis_workspace>/authoring-svg" --projection-kind generic
python3 skills/aws-ppt-master/scripts/extract_svg_assets.py "<svg_analysis_workspace>/authoring-svg" --icons-dir "<svg_analysis_workspace>/icons" --icon-namespace imported --inplace --id-prefix source --min-decoration-bytes 3000 --clean-stale
```
...
```bash
python3 skills/aws-ppt-master/scripts/template_preview_pptx.py "<authoring_workspace>" [--force] [--native-charts-and-tables -o <distinct_path>]
```
...
```bash
python3 skills/aws-ppt-master/scripts/apply_template.py <project_path> --root <workspace_root> [--root <workspace_root> ...] [--dry-run] [--skip-validation]
```
...
```bash
python3 skills/aws-ppt-master/scripts/register_template.py <template_id> --kind brand|style|layout|deck [--dry-run]
python3 skills/aws-ppt-master/scripts/register_template.py --kind style|deck|layout --rebuild-all
```
