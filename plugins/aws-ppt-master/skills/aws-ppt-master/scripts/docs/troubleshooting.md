...
1. Place one supported audio file (`m4a`, `mp3`, or `wav`) per slide under `audio/`, matching filenames with the split `notes/*.md` files.
...
- `boto3` for the Bedrock image generation backend
