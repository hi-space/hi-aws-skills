...
~~~bash
python3 skills/aws-ppt-master/scripts/pptx_animations.py --describe-transition page_curl
python3 skills/aws-ppt-master/scripts/pptx_animations.py --describe-transition diamond
~~~
