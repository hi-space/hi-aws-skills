...
If the site has only one family, keep the schematic defaults for the missing roles (Amazon Ember for title, Amazon Ember Mono for mono). Don't force-pick a mono font that isn't on the site.
