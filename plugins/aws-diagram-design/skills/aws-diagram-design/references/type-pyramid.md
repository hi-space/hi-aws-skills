...
- Each layer has:
  - **Name label** centered inside the trapezoid — Amazon Ember 12–14px 600.
  - **Sublabel** below or beside the name — Amazon Ember Mono 9–10px.
...
- Optional left-margin axis arrow + Amazon Ember Mono label (`rarer ↑`, `drop-off ↓`).
