...
- Tick marks at time boundaries (quarters, months, sprints) with date labels below in Amazon Ember Mono.
...
- Major milestones: coral circle (`r=6`) + bold Amazon Ember label.
