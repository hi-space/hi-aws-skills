...
> **Naming a specific AWS service?** Use the official AWS Architecture Icons instead — [primitive-aws-icons.md](primitive-aws-icons.md) (812 icons bundled under `assets/aws-icons/`). This monochrome set is for generic/non-AWS infrastructure and for diagrams that must stay single-ink.
...
### aws
Amazon Web Services — generic monochrome mark. For any *named* AWS service (EC2, Lambda, S3, …) use the official set in [primitive-aws-icons.md](primitive-aws-icons.md) instead.
